...
namespace AngryLibs.Controllers
{
  public class FantasyController : Controller
  {
    ...
    [Route("/EndRHStory")]
    public ActionResult NewRobinHood(string name1, string noun1, string noun2, string noun3, string noun4, string noun5, string noun6, string adjective1,string adjective2,string adjective3,string adjective4)
    {
